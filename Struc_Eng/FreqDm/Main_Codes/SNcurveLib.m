...
SNcurve.ABS_E_Air.t_ref = 22; %mm, reference thickness for thickness correction
SNcurve.ABS_E_Air.kcorr = 0.25; %exponent for thickness correction
...
SNcurve.ABS_B_Air.S0 = 100.2; %MPa
...
SNcurve.ABS_E_Test.t_ref = 22; %mm, reference thickness for thickness correction
SNcurve.ABS_E_Test.kcorr = 0.25; %exponent for thickness correction
