function[] = plot_TopBtm_FatigLife (data,path,PartName,DotSize)
...
figure(1)
scatter3(data(:,2),data(:,3),data(:,4),DotSize,1./data(:,5),'filled')
axis equal
colorbar
...
figure(2)
scatter3(data(:,2),data(:,3),data(:,4),DotSize,1./data(:,6),'filled')
axis equal
colorbar
