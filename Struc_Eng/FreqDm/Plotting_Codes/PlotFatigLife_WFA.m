...
tolerance1 = 30;
%%
%------------------- New group - box K-joint ------------------------------
% GroupName = 'BoxKJnt_CG1';
% StrFile = [path1 GroupName '.csv'];
% StrData = importdata(StrFile);
% 
% data1 = sort_zval(StrData, Z_Keel, Z_Keel + EL_BoxLMBtop); %All LMBs
% 
% 
% Part1 = 'LMB12 mid';
% 
...
% 
% FatigLife0(1,:) = min(Str_part1(:,5:6));
% plot_TopBtm_FatigLife (Str_part1,path1,Part1,40)
% 
% OutputName = [path1,Part1,'.csv'];
...
% 
% FatigLife0(2,:) = min(Str_part2(:,5:6));
% plot_TopBtm_FatigLife (Str_part2,path1,Part2,40)
% 
% OutputName = [path1,Part2,'.csv'];
...
% 
% FatigLife0(3,:) = min(Str_part3(:,5:6));
% plot_TopBtm_FatigLife (Str_part3,path1,Part3,40)
% 
% OutputName = [path1,Part3,'.csv'];
...
% close all
% 
% data1 = sort_zval(StrData, Z_Keel + EL_BoxLMBtop+tolerance1, Z_Keel + EL_PlfmBtm); %All LMBs
% 
% Part4 = 'VB12lwr';
% 
% data2 = sort_yval(data1, YBound(2), YBound(1));
% Str_part4 = sort_xydist(data2, ColSpace/2-L_LMBmidcan/2, ColSpace/2+L_LMBmidcan/2, Ctr_Col1(1), Ctr_Col1(2));
% 
% FatigLife0(4,:) = min(Str_part4(:,5:6));
% plot_TopBtm_FatigLife (Str_part4,path1,Part4,40)
% 
% OutputName = [path1,Part4,'.csv'];
...
% 
% data2 = sort_yval(data1,YBound(3),YBound(2));
% Str_part5 = sort_xydist(data2, ColSpace/2-L_LMBmidcan/2, ColSpace/2+L_LMBmidcan/2, Ctr_Col1(1), Ctr_Col1(2));
% 
% FatigLife0(5,:) = min(Str_part5(:,5:6));
% plot_TopBtm_FatigLife (Str_part5,path1,Part5,40)
% 
% OutputName = [path1,Part5,'.csv'];
...
% 
% data2 = sort_xval(data1,XBound(3),XBound(2));
% Str_part6 = sort_yval(data2, -L_LMBmidcan/2,L_LMBmidcan/2);
% 
% FatigLife0(6,:) = min(Str_part6(:,5:6));
% plot_TopBtm_FatigLife (Str_part6,path1,Part6,40)
% 
% OutputName = [path1,Part6,'.csv'];
...
Str_part10 = sort_xydist(data1, 0, ColSpace/2 - L_LMBmidcan/2, Ctr_Col1(1), Ctr_Col1(2));
...
Str_part11 = sort_xydist(data1, 0, ColSpace/2 - L_LMBmidcan/2, Ctr_Col2(1), Ctr_Col2(2));
...
Str_part12 = sort_xydist(data1, 0, ColSpace/2 - L_LMBmidcan/2, Ctr_Col3(1), Ctr_Col3(2));
...
Str_part22 = sort_xyzdist(StrData, 0, L_VBcolcan1, TrussCtr_Col2);
FatigLife(22,:) = min(Str_part22(:,5:6));
plot_TopBtm_FatigLife (Str_part22,path2,Part22,40)

OutputName = [path2,Part22,'.csv'];
csvwrite(OutputName,Str_part22)
OutputName1 = [path2,Part22,'.mat'];
save(OutputName1,'Str_part22')

Part23 = 'VBcan Col3';

Str_part23 = sort_xyzdist(StrData, 0, L_VBcolcan1, TrussCtr_Col3);
FatigLife(23,:) = min(Str_part23(:,5:6));
plot_TopBtm_FatigLife (Str_part23,path2,Part23,40)

OutputName = [path2,Part23,'.csv'];
csvwrite(OutputName,Str_part23)
OutputName1 = [path2,Part23,'.mat'];
save(OutputName1,'Str_part23')
%%
% ------------------ End of first group ---------------------------
% ------------------ Second group:  IS ----------------------------
...
Str_part401 = sort_xval(StrData,KJnt12_Ctr(1),XBound(1)); %Col1
FatigLife4(1,:) = min(Str_part401(:,5:6));
plot2d_TopBtm_FatigLife (Str_part401,path2,Part401,40)

OutputName = [path2,Part401,'.csv'];
csvwrite(OutputName,Str_part401)
OutputName1 = [path2,Part401,'.mat'];
save(OutputName1,'Str_part401')

close all

data1 = sort_xval(StrData,XBound(3),KJnt12_Ctr(1)); %Col2&3

Part402 = 'WEP Col2';

Str_part402 = sort_yval(data1,YBound(2),YBound(1)); %Col2
FatigLife4(2,:) = min(Str_part402(:,5:6));
plot2d_TopBtm_FatigLife (Str_part402,path2,Part402,40)

OutputName = [path2,Part402,'.csv'];
csvwrite(OutputName,Str_part402)
OutputName1 = [path2,Part402,'.mat'];
save(OutputName1,'Str_part402')

close all

Part403 = 'WEP Col3';

Str_part403 = sort_yval(data1,YBound(3),YBound(2)); %Col3
FatigLife4(3,:) = min(Str_part403(:,5:6));
plot2d_TopBtm_FatigLife (Str_part403,path2,Part403,40)

OutputName = [path2,Part403,'.csv'];
csvwrite(OutputName,Str_part403)
OutputName1 = [path2,Part403,'.mat'];
save(OutputName1,'Str_part403')
...
% StrData = importdata(StrFile);
% 
% Part502 = 'Flat Top Col23';
% 
% Str_part502 = sort_zval(StrData,Z_Keel+EL_Top-100,Z_Keel+EL_Top+100);
% FatigLife5(2,:) = min(Str_part502(:,5:6));
% plot2d_TopBtm_FatigLife (Str_part502,path1,Part502,40)
% 
% OutputName = [path1,Part502,'.csv'];
% csvwrite(OutputName,Str_part502)
% 
% close all
% 
% data1 =  sort_xval(StrData,XBound(2),XBound(1)); %Col1
% 
% Part503 = 'Flat mid Col1';
% Str_part503 = sort_zval(data1,Z_Keel+100,Z_Keel+EL_Top-100);
% FatigLife5(3,:) = min(Str_part503(:,5:6));
% plot_TopBtm_FatigLife (Str_part503,path1,Part503,40)
% 
% OutputName = [path1,Part503,'.csv'];
% csvwrite(OutputName,Str_part503)
% 
% close all
% 
% Part504 = 'Flat keel Col1';
% Str_part504 = sort_zval(data1,Z_Keel,Z_Keel+100);
...
% data2 = sort_yval(data1,YBound(2),YBound(1));%Col2
% 
% Part505 = 'Flat mid Col2';
% Str_part505 = sort_zval(data2,Z_Keel+100,Z_Keel+EL_Top-100);
% FatigLife5(5,:) = min(Str_part505(:,5:6));
% plot_TopBtm_FatigLife (Str_part505,path1,Part505,40)
% 
% OutputName = [path1,Part505,'.csv'];
% csvwrite(OutputName,Str_part505)
% 
% close all
% 
% Part506 = 'Flat keel Col2';
% Str_part506 = sort_zval(data2,Z_Keel,Z_Keel+100);
...
% data2 = sort_yval(data1,YBound(3),YBound(2));%Col3
% 
% Part507 = 'Flat mid Col3';
% Str_part507 = sort_zval(data2,Z_Keel+100,Z_Keel+EL_Top-100);
% FatigLife5(7,:) = min(Str_part507(:,5:6));
% plot_TopBtm_FatigLife (Str_part507,path1,Part507,40)
% 
% OutputName = [path1,Part507,'.csv'];
% csvwrite(OutputName,Str_part507)
% 
% close all
% 
% Part508 = 'Flat keel Col3';
% Str_part508 = sort_zval(data2,Z_Keel,Z_Keel+100);
