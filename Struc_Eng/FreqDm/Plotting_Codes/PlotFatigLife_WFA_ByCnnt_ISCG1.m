...
%%
PartName = 'IStop Col1';
PartThk1 = Thk.Col1.TB; %Part thickness
PartThk2 = Thk.Col1.IStopfrnt; %Part thickness
...
n = 3;
SN = 'API_WJ_Air';
data1 = sort_zval (StrData, Z_Keel + EL_PlfmBtm, Z_Keel+EL_UMBtop-3*R_UMB);
plot_TopBtm_FatigLife(data1,path3,CnntName,DotSize)
Result{n} = FatigueResult(path1, GroupName, data1, CnntName, SN, PartThk2);
