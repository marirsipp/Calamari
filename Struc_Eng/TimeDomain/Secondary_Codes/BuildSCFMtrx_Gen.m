function [] = BuildSCFMtrx_Gen (path_str, path_SCF, LineNo, PartName, TorB, StrNominal ,CutRto)
...
header(6:11) = {'SCF_Fx','SCF_Fy','SCF_Fz','SCF_Mx','SCF_My','SCF_Mz'};
header(12) = {'MxorMy'};
...
format1 = ['%8s',',', repmat(['%6s',','],1,3), '%7s', repmat([',','%6s'],1,7),'\n'];
