...
strBatch = 'BatchA_Conv_Bin198'; %in path0 this is a directory where the loads exist
...
ModelType = 'PlfmBtm'; %where on the platform the current model focuses on, the options are: 'Col1Top', 'Col2Top', 'Col3Top', 'PlfmBtm', 'Col1MC', 'Col2MC'
