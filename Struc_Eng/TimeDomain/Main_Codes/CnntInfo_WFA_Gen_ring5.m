...
%% Platform Bottom
elseif strcmp(ModelType, 'Ring5') %Based on Itr16_7_2
...
%     Cnnt.L415.LMB12.HspTol = 250;
    ...
    Cnnt.L417.FB21.thk = Thk.Nominal.FBsplice;
    ...
    Cnnt.L433.Ring5.thk = Thk.Nominal.LMBSpRing5;
    Cnnt.L433.Ring5.int = 1;
    Cnnt.L433.Ring5.axisTT = 'z'; %through-thickness axis
    Cnnt.L433.Ring5.SDir = 0; %degree
    
    Cnnt.L433.Ring5Brkt.thk = Thk.Nominal.LMBSpRing5;
    Cnnt.L433.Ring5Brkt.int = 1;
    Cnnt.L433.Ring5Brkt.axisTT = 'z'; %through-thickness axis
    Cnnt.L433.Ring5Brkt.SDir = 0; %degree
...
elseif strcmp(ModelType, 'Col1MC')
    ...
    Cnnt.L111.OS.SDir = 90; %degree
        ...
        %Line12 - L1211_Rg850_EFln
    Cnnt.L1211.SN = 'ABS_E_CP';
    Cnnt.L1211.group = 'circ';
    Cnnt.L1211.axis = 'y';
    
    Cnnt.L1211.Rg850.thk = Thk.Col1.Rg850;
    Cnnt.L1211.Rg850.int = 1;
    Cnnt.L1211.Rg850.axisTT = 'z'; %through-thickness axis
    Cnnt.L1211.Rg850.SDir = 90; %degree
    
    Cnnt.L1211.EFln.thk = Thk.Col1.EFln;
    Cnnt.L1211.EFln.int = 1;
    Cnnt.L1211.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1211.EFln.SDir = 90; %degree
    
    %Line13 - L1221_FlN_EFln
    Cnnt.L1221.SN = 'ABS_E_CP';
    Cnnt.L1221.group = 'circ';
    Cnnt.L1221.axis = 'y';
    
    Cnnt.L1221.FlN.thk = Thk.Col1.FlN;
    Cnnt.L1221.FlN.int = 1;
    Cnnt.L1221.FlN.axisTT = 'x'; %through-thickness axis
    Cnnt.L1221.FlN.SDir = 90; %degree
    
    Cnnt.L1221.EFln.thk = Thk.Col1.EFln;
    Cnnt.L1221.EFln.int = 1;
    Cnnt.L1221.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1221.EFln.SDir = 90; %degree
    
    %Line12 - L1201_StN_EFln
    Cnnt.L1201.SN = 'ABS_E_CP';
    Cnnt.L1201.group = 'circ';
    Cnnt.L1201.axis = 'x';
    
    Cnnt.L1201.StN.thk = Thk.Col1.StN;
    Cnnt.L1201.StN.int = 1;
    Cnnt.L1201.StN.axisTT = 'y'; %through-thickness axis
    Cnnt.L1201.StN.SDir = 90; %degree
    
    Cnnt.L1201.EFln.thk = Thk.Col1.EFln;
    Cnnt.L1201.EFln.int = 1;
    Cnnt.L1201.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1201.EFln.SDir = 90; %degree
...
elseif strcmp(ModelType, 'Col2MC')
    ...
    Cnnt.L1211.Rg850.thk = Thk.Col23.Rg850;
    Cnnt.L1211.Rg850.int = 3;
    Cnnt.L1211.Rg850.axisTT = 'z'; %through-thickness axis
    Cnnt.L1211.Rg850.SDir = 90; %degree
    
    Cnnt.L1211.EFln.thk = Thk.Col23.EFln;
    Cnnt.L1211.EFln.int = 3;
    Cnnt.L1211.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1211.EFln.SDir = 90; %degree
    ...
    Cnnt.L1221.FlN.thk = Thk.Col23.FlN;
    Cnnt.L1221.FlN.int = 3;
    Cnnt.L1221.FlN.axisTT = 'z'; %through-thickness axis
    Cnnt.L1221.FlN.SDir = 90; %degree
    
    Cnnt.L1221.EFln.thk = Thk.Col23.EFln;
    Cnnt.L1221.EFln.int = 3;
    Cnnt.L1221.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1221.EFln.SDir = 90; %degree
    ...
    Cnnt.L1201.StN.thk = Thk.Col23.StN;
    Cnnt.L1201.StN.int = 3;
    Cnnt.L1201.StN.axisTT = 'y'; %through-thickness axis
    Cnnt.L1201.StN.SDir = 90; %degree
    
    Cnnt.L1201.EFln.thk = Thk.Col23.EFln;
    Cnnt.L1201.EFln.int = 3;
    Cnnt.L1201.EFln.axisTT = 'z'; %through-thickness axis
    Cnnt.L1201.EFln.SDir = 90; %degree
    
    %Line13 - L1301_StN_Flng
    Cnnt.L1301.SN = 'ABS_E_CP';
    Cnnt.L1301.group = 'circ';
    Cnnt.L1301.axis = 'x';
    
    Cnnt.L1301.StN.thk = Thk.Col23.StN;
    Cnnt.L1301.StN.int = 3;
    Cnnt.L1301.StN.axisTT = 'y'; %through-thickness axis
    Cnnt.L1301.StN.SDir = 90; %degree
    
    Cnnt.L1301.Flng.thk = Thk.Col23.Flng;
    Cnnt.L1301.Flng.int = 3;
    Cnnt.L1301.Flng.axisTT = 'z'; %through-thickness axis
    Cnnt.L1301.Flng.SDir = 90; %degree

%% VB One side welding check    
elseif strcmp(ModelType, 'VB_nm')
    %Line1 - L99_VB12_nm_upper
    Cnnt.L99.SN = 'ABS_F_CP';
    Cnnt.L99.group = 'circ';
    Cnnt.L99.axis = 'y';

    Cnnt.L99.VB12.thk = Thk.Nominal.VB1;
    Cnnt.L99.VB12.axisTT = 'x';
    Cnnt.L99.VB12.int = 3;
    Cnnt.L99.VB12.SDir = 180;
    
    Cnnt.L98.SN = 'ABS_F_CP';
    Cnnt.L98.group = 'circ';
    Cnnt.L98.axis = 'y';

    Cnnt.L98.VB12.thk = Thk.Nominal.VB1;
    Cnnt.L98.VB12.axisTT = 'x';
    Cnnt.L98.VB12.int = 3;
    Cnnt.L98.VB12.SDir = 180;
    
    Cnnt.L97.SN = 'ABS_F_CP';
    Cnnt.L97.group = 'circ';
    Cnnt.L97.axis = 'y';

    
    Cnnt.L97.VB13.thk = Thk.Nominal.VB1;
    Cnnt.L97.VB13.axisTT = 'x';
    Cnnt.L97.VB13.int = 3;
    Cnnt.L97.VB13.SDir = 180;

    Cnnt.L96.SN = 'ABS_F_CP';
    Cnnt.L96.group = 'circ';
    Cnnt.L96.axis = 'y';
    
    
    Cnnt.L96.VB13.thk = Thk.Nominal.VB1;
    Cnnt.L96.VB13.axisTT = 'x';
    Cnnt.L96.VB13.int = 3;
    Cnnt.L96.VB13.SDir = 180;
