...
strBatch = 'Orcaflex_loads_for_MC\MC_Col3'; %in path0 this is a directory where the loads exist
...
prob_adjust = 'y'; %Use adjusted probability in DEL and dmg calculation (Vestas had 113%!!) so the sum of probabilities should be 1
...
LoadValue = [100, 100, 100, 100, 100, 100]; %kN for forces and kNm for moments, value of unit loads applied in ANSYS
...
%spot
method = 1;
% filenum =[27,28]; % Uncomment if you want only first path to be post-processed
