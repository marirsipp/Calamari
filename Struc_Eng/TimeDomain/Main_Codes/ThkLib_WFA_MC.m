...
Thk(n).Col23.OS        = 20;
Thk(n).Col23.MC        = 30;
Thk(n).Col23.MCatt     = 50; % Mooring Pin Attachement reinforced
Thk(n).Col23.MCrf      = 20; % Stiffeners inside OS to reinforce at the MC location
Thk(n).Col23.Pin       = 200;
...
Thk(n).Col1.OS        = 22;
Thk(n).Col1.MC        = 30;
Thk(n).Col1.MCatt     = 50; % Mooring Pin Attachement reinforced
Thk(n).Col1.MCrf      = 28; % Stiffeners inside OS to reinforce at the MC location
Thk(n).Col1.Pin       = 200;
