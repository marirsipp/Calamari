...
ItrNo = 'ItrR5_15_20';
strBatch = 'BatchA_Conv_Bin198_1'; %in path0 this is a directory where the loads exist
file_pwr = 'vals.mat'; % for imat = 2, name of file of basebend loads
...
Loads = {'Fx';'Fy';'Fz';'Mx';'My';'Mz'}; %{'Fx1';'Fx2';'Fy1';'Fy2';'Fz1';'Fz2'}; %we can have {Fx1, Fy1,Fz1,Fx2, Fy2,Fz2} or {Fx, Fy,Fz} instead of {Fx, Fy,Fz,Mx,My,Mz}
LoadValue = [100, 100, 100, 1000, 1000, 1000]; %kN for forces and kNm for moments, value of unit loads applied in ANSYS
StrUnit = 'MPa'; %Unit of the stress output from ANSYS
ModelType = 'Col1Top'; %where on the platform the current model focuses on, the options are: 'Col1Top', 'Col2Top', 'Col3Top', 'PlfmBtm', 'Col1MC', 'Col2MC'
